...
- Commit and publish the current app/backend acceptance evidence, deploy the current website commit, and complete the post-deployment smoke checklist. Local validation alone does not prove production parity.
